...
def create_app(test_config=None):
    ...
    def submitQuestion():
        ...
        try:
            category = Category.query.filter_by(
                type=request_data.get("category").capitalize()).first()
            question = Question(request_data.get("question"), request_data.get(
                "answer"), category.id, request_data.get("difficulty"))
            question.insert()
    ...
    def getByCategory(category_type):
        questionslist = []
        category = Category.query.filter_by(
            type=category_type.capitalize()).first()
